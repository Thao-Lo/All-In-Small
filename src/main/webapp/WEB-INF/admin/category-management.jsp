    ...
    <div class="container-fluid pt-3 pb-2 px-3">
      <nav class="main-nav ">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
          ...
          <a href="/admin/category-edit" class="btn dashboard-button custom-shadow rounded align-self-start me-3">+ Add New Category</a>
        </div>
      </nav>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="/admin/category-edit" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                        <!-- START DELETE ITEMS -->
                        <span> / </span>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="px-2 py-1">     
                            <h6 class="mb-0 text-sm">Drink</h6>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="px-2 py-1">     
                            <h6 class="mb-0 text-sm">Add On</h6>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">1</p>                      
