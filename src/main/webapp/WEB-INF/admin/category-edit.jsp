...
<body class="container-fluid">
        ...
        <div class="d-flex justify-content-between">
          <div style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item " aria-current="page"><a href="/admin/category-management">Category</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="row mt-5">
            ...
            <div class="col-2"></div>
            <form id="category-form" class="col-12 col-md-8" action="/category" method="post" enctype="multipart/form-data">
              <div class="form-floating mb-3 custom-shadow">
                <input type="number" class="form-control" id="floatingInputDisabled" name="categoryId" disabled>
              ...
              <div class="form-floating mb-3 custom-shadow">
                <input type="number" class="form-control" id="category-priority" name="priority">
                <label for="category-priority">Category Priority</label>
              </div>
              ...
              <a id="back-to-homepage" class="btn col-6 col-md-4 dashboard-button d-flex justify-content-center align-items-center" type="button" href="/"
                data-bs-toggle="modal" data-bs-target="#staticBackdrop">Back To Home Page</a></div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Your Category information will not be saved to the database
                  </div>
  ...
  <script src="/script/category-form-validation.js"></script>
  <script>
