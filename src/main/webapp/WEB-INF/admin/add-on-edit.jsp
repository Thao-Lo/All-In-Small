  ...
  <main class="page-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="d-flex justify-content-between">
          <div style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="../admin/product-management.html">Product</a></li>
              <li class="breadcrumb-item " aria-current="page"><a href="../admin/add-on-management.html">Add-On</a>
              </li>
    ...
    <div class=" main-content container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="row mt-3">
            <h1 class="text-center">Add New Add-On Item</h1>
            <div class="col-2"></div>
            <form id="product-form" class="col-12 col-md-8" action="/product" method="post"
              ...
              <div class="form-floating mb-3 custom-shadow">
                ...
                <label for="product-name">Add-on Name</label>
              </div>
              <div class="form-floating mb-3 custom-shadow">
                <input type="number" class="form-control" id="product-price" name="price" required>
                <label for="product-price">Add-on Price</label>
              </div>
              ...
              <div class="input-group mb-3 custom-shadow">
                ...
                <select class="form-select flex-1" id="select-category" required>
                  <option selected disabled value="">Open this select Category</option>
              ...
              <div class="d-flex justify-content-center gap-3">
                <button type="submit" class="btn dashboard-button">
                  <div class="p-2 px-3">Save Add-on</div>
                </button>
