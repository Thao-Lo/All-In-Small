            ...
            <div class="col-12">
              <div class="row mt-3">
                ...
                <form id="product-form" class="col-12 col-md-8" action="/product" method="post"
                  ...
                  <!-- CHECK BOX -->
                  <div class="check-box mb-3 border border-secondary-subtle bg-white custom-shadow">
                    <div class="add-on mb-2 p-2 ps-3 border-bottom bg-light-subtle">Select Add On</div>
                    <div class="row px-3 mb-2">
                      <div class="col-lg-4 col-6 form-check">
                        <input class="form-check-input" type="checkbox" id="flexCheckDefault" value="extra-chicken">
                        <label class="form-check-label" for="flexCheckDefault">Extra Chicken</label>
                      </div>
                      <div class="col-lg-4 col-6 form-check">
                        <input class="form-check-input" type="checkbox" id="flexCheckDefault" value="extra-vegetable">
                        <label class="form-check-label" for="flexCheckDefault">Extra vegetable</label>
                      </div>
                      <div class="col-lg-4 col-6 form-check">
                        <input class="form-check-input" type="checkbox" id="flexCheckDefault" value="extra-cheese">
                        <label class="form-check-label" for="flexCheckDefault">Extra Cheese</label>
                      </div>

                    </div>
                  </div>
                  <div class="mb-3 custom-shadow">
                    <input type="file" id="upload-image" class="form-control" aria-label="file example" name="imageData"
                      required>
                  ...
                  <div class="d-flex justify-content-center gap-3">
                    ...
                    <a id="back-to-homepage"
                      class="btn col-6 col-md-4 dashboard-button d-flex justify-content-center align-items-center px-3 "
